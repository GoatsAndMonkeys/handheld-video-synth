"""A 5x8 bitmap font in a 6x9 cell, for on-screen menus.
...
Metrics: glyphs are 5x8 with a one-pixel gutter right and below, so the
advance is 6x9. At the 320-wide menu panel that is 53 columns against
the 44 the 11px outline font managed, so rows have more room, not less.
Integer scale only — half a pixel is exactly what this font exists to
avoid.
...
W = 5           # glyph box
H = 8
ADV = 6         # cell advance, glyph plus gutter
LINE = 9
