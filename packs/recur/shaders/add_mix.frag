// from langolierz/r_e_c_u_r Shaders/2-input/add_mix.frag (GPL-3.0)
...
// output frame. Note the two variant functions below are identical upstream
// (the second knob switches between them but nothing visibly changes); kept
// as written.
//2-input
#ifdef GL_ES
